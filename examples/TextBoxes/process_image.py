...
model_def = curr_dir+'/deploy.prototxt'
...
save_detection_path=save_dir+'res_1.txt'
...
dest_dir="/".join(image_path.split("/")[0:-1])
inp_file_name=image_path.split("/")[-1]

dest_path=dest_dir+"/"+inp_file_name.split(".")[0]+"_TextBoxes.jpg"
